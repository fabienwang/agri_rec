    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'create':
                ...
                $stmt = $db->prepare('INSERT INTO produits_phytosanitaires (nom, unite_emballage, amm) VALUES (:nom, :unite_emballage, :amm)');
                $stmt->bindValue(':nom', $nom, SQLITE3_TEXT);
                $stmt->bindValue(':unite_emballage', $unite_emballage, SQLITE3_TEXT);
            ...
            case 'update':
                ...
                $stmt = $db->prepare('UPDATE produits_phytosanitaires SET nom = :nom, unite_emballage = :unite_emballage, amm = :amm WHERE id = :id');
            ...
            case 'delete':
                ...
                $stmt = $db->prepare('DELETE FROM produits_phytosanitaires WHERE id = :id');
                $stmt->bindValue(':id', $id, SQLITE3_INTEGER);
                $stmt->execute();
                break;
        }
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <button onclick="showUpdateForm(<?php echo htmlspecialchars(json_encode($produit)); ?>)">Modifier</button>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
    ...
    <div id="updateForm" style="display:none;">
        ...
        <form method="post">
            ...
            <input type="text" name="amm" id="update_amm" required>
